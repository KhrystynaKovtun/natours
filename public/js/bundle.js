...
var alert = function alert(status, message) {
  hideAlert();
  var el = "<div class=\"alert alert--".concat(status, "\">").concat(message, "</div>");
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            console.log(email, password, 'http://127.0.0.1:8080/api/v1/users/login');
            _context.prev = 1;
            _context.next = 4;
          ...
          case 4:
            ...
            if (res.data.status === 'success') {
              (0, _alert.alert)('success', 'You are successfully logged in!');
              setTimeout(function () {
                location.assign('/');
              }, 500);
            }
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alert.alert)('success', 'You are successfully logged out!');
          ...
          case 7:
            ...
            (0, _alert.alert)('error', 'We have difficulties to log you out!');
...
},{"axios":"../../node_modules/axios/index.js","./alert":"alert.js"}],"userSettings.js":[function(require,module,exports) {
"use strict";
  ...
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(data, type) {
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            url = "http://127.0.0.1:8080/api/v1/users/".concat(type === 'password' ? 'updateMyPassword' : 'updateMe');
            _context.prev = 1;
            _context.next = 4;
            return (0, _axios.default)({
              method: 'patch',
          ...
          case 4:
            ...
            if (res.data.status === 'success') {
              (0, _alert.alert)('success', "You successfully updated ".concat(type, "!"));
            }
...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1Ijoia2hyeXN0eW5hLWtvdnR1biIsImEiOiJja2d4Y2tscHMwNm9nMzFwZGdxNHI3eHY5In0.u1Ij9LLFQTR4nVe90hmBsg'; // mapboxgl.accessToken = 'pk.eyJ1Ijoia2hyeXN0eW5hLWtvdnR1biIsImEiOiJja2d4Y25kbmgwaW1mMnlwZnNhcG5nZ3lpIn0.9saLVVC7v48_gNk4eWzMjw';
...
var _userSettings = require("./userSettings.js");
...
var locations = document.getElementById('map');
var loginForm = document.querySelector('.form-login');
var userDataForm = document.querySelector('.form-user-data');
var userPasswordForm = document.querySelector('.form-user-passwords');
var logoutBtn = document.querySelector('.nav__el--logout');

if (locations) {
  (0, _mapbox.displayMap)(JSON.parse(locations.dataset.locations));
}
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            _context.next = 6;
            return (0, _userSettings.updateUserInfo)({
              password: password,
